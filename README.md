...
- [operantlabs/operant-mcp](https://github.com/operantlabs/operant-mcp) - Security testing with 51 tools for penetration testing, network forensics, and vulnerability assessment.
